...
timetableRouter.post("/generate", (req, res) =>
  timetableController.generate(req, res),
);
timetableRouter.get("/latest", (req, res) =>
  timetableController.getLatest(req, res),
);
timetableRouter.get("/entries", (req, res) =>
  timetableController.getEntriesByFilter(req, res),
);
timetableRouter.get("/:id", (req, res) =>
